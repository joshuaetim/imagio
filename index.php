<?php
    ...
    $getPhoto = $photo->getImages($query['id']);
...
?>
    ...
    <div class="container p-4">
        <h3>Welcome, <?=$query['username']?> <a href="addimage" class="btn btn-success float-right">Upload Image</a></h3>
        ...
        <p>
            <?php
                if($count < 1){
                    echo 'You haven\'t uploaded an image yet';
                }
                else{
            ?>
        </p>
